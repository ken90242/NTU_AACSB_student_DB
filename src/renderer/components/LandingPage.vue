      ...
      <ul style="margin-left:20px">
        ...
        <li>
          ...
          <ol style="margin-left:10px">
            <li>功能(Celia)：檢視歷年資料預設列出最新年度</li>
            <li>修正(Celia)：歷年資料-畢業標準的顯示改為以頁籤選擇，去除Scroll bar</li>
            *原先設計為不論選取幾項/頁，都可以顯示該年度下的所有項目。
            現為避免混淆scroll bar與頁籤使用 -> 讓項目數量不會超過當前頁面長度(讓scroll bar不會出現) -> 固定項目數至5項/頁
            <li>修正(Lisa)：修改畢業標準警示規則</li>
            *原只要出現休學狀況便警示 -> 若拿到學分的第一學期非該年度則警示(EX: R08XXXXX，109-1才拿到第一個學分則出現警告)
            <li>修正(Lisa)：在學時間與畢業時間改為學期制</li>
            *8/1 ~ 1/31 第一學期，2/1 ~ 7/31 第二學期
            <li>修正(Lisa)：更改已修學分與應修學分介面(EX: 12/30)</li>
            <li>修正(Lisa)：將停修學分從已修學分移除</li>
            <li>修正(Christy)：帳號搜尋頁面僅顯示50筆資料，也無下一頁選項</li>
            * bug原因是當初避免頁面渲染導致卡頓，所以僅列出50項，所以僅列出50項
            <li>功能(Christy)：增加指導教授欄位</li>
          </ol>
        </li>
      </ul> 
    </div>
